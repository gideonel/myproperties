...
const PropertyEditForm = () => {
  ...
  const handleToggleChange = (e) => {
    ...
    setFields((prevFields) => {
      console.log('Previous fields:', prevFields); // Log previous state
      console.log('Updated value:', checked); // Log new value
      return {
        ...prevFields,
        [name]: checked,
      };
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label htmlFor="is_featured" className="flex items-center cursor-pointer">
            ...
            <div className="relative">
              ...
              <div className={`absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition-transform ${fields.is_featured ? 'translate-x-full bg-green-500' : 'translate-x-0 bg-gray-500'}`}></div>
            </div>
            <span className="ml-3 text-sm">Mark as featured</span>
          </label>
        </div>
